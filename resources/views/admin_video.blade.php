            ...
            <main class="w-full flex-grow p-6">
                <div class="w-full mt-6">
                    <p class="text-xl pb-3 flex items-center">
                        <i class="fas fa-list mr-3"></i> Input Video
                    </p>
                    ...
                    <div class="leading-loose">
                        <form class="p-10 bg-white rounded shadow-xl">
                            ...
                            <div class="mt-2">
                                ...
                                <input class="w-full px-5  py-4 text-gray-700 bg-gray-200 rounded" id="video" name="video" type="file" required="" aria-label="video">
                            </div>
                            <div class="mt-2">
                                <label class=" block text-sm text-gray-600" for="deskripsi">Deskripsi</label>
                                <textarea class="w-full px-5 py-2 text-gray-700 bg-gray-200 rounded" id="deskripsi" name="deskripsi" rows="6" required="" placeholder="Deskrips Video" aria-label="deskripsi"></textarea>
                            </div>
                            <div class="mt-6">
